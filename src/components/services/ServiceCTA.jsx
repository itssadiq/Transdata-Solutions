    ...
    <section className="py-20 md:py-24 bg-td-yellow">
      ...
      <div className="max-w-[1400px] mx-auto px-6 md:px-10 flex flex-col lg:flex-row items-center justify-between gap-10">
        <div className="text-center lg:text-left">
          ...
          <p className="text-black/80 font-bold text-lg md:text-xl max-w-2xl leading-relaxed">
        ...
        <Link
          to="/contact"
          className="group bg-black text-white px-10 py-5 font-bold uppercase tracking-widest text-sm flex items-center gap-4 hover:bg-white hover:text-black transition-all duration-300 shadow-2xl rounded-sm"
        >
