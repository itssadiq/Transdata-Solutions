...
export const servicesData = {
  ...
  // SUB-CATEGORY 21: SERVICENOW EXPERTISE
  "servicenow-expertise": {
    ...
    benefits: [
      ...
      "Best-Practice Aligned Solutions",
    ...
    extraSections: [
      {
        title: "Core ServiceNow Expertise Areas",
        content:
          "Our certified resources bring deep functional and technical expertise across the ServiceNow ecosystem to help you build scalable and intelligent operations.",
        listTitle: "Specialized Modules",
        items: [
          "Strategic Portfolio Management (SPM): Demand, project, and portfolio management, resource planning, and financial visibility with enterprise alignment.",
          "ITOM Suite: End-to-end IT operations automation, infrastructure visibility, control, and proactive issue detection.",
          "Discovery: Automated infrastructure discovery with accurate asset mapping and real-time environment visibility to reduce manual CMDB updates.",
          "Service Mapping: Business service modeling and application dependency mapping to improve incident, change management, and impact analysis.",
          "Event Management: Intelligent event correlation, noise reduction, alert optimization, and root cause identification.",
          "CMDB & CSDM Specialists: Architecture design, framework implementation, data governance, and CI normalization for lifecycle management.",
        ],
      },
      {
        title: "Flexible Engagement Models",
        content:
          "We offer engagement models designed to suit your specific business needs and transformation goals.",
        listTitle: "How We Partner",
        items: [
          "Dedicated ServiceNow Resources: Long-term experts focused exclusively on your platform success.",
          "Project-Based Delivery Teams: Specialized squads for targeted implementation and rollout projects.",
          "Staff Augmentation: Highly skilled professionals to fill critical gaps within your existing internal teams.",
          "Managed Services Model: Full-scale platform administration, optimization, and ongoing support.",
          "Consulting & Advisory: Strategic guidance on platform roadmap, architecture, and best practices.",
          "Deployment Flexibility: Both short-term and long-term resource deployment options available.",
        ],
      },
    ],

    processTitle: "Build Your ServiceNow Success",
    processSubtitle:
      "Partner with Transdata Talent Solutions to access experts who don’t just implement platforms — they build scalable, intelligent, and future-ready digital operations.",
    processSteps: [
      {
        num: "01",
        title: "Inquiry",
        desc: "Contact us to explore how our ServiceNow talent can support your journey.",
      },
      {
        num: "02",
        title: "Strategy",
        desc: "Developing a roadmap for implementation, automation, and value delivery.",
      },
      {
        num: "03",
        title: "Deployment",
        desc: "Executing module configuration, customization, and platform optimization.",
      },
      {
        num: "04",
        title: "Scaling",
        desc: "Enabling long-term value through governance, integrations, and managed support.",
      },
    ],
  },
};
